...
export type Database = {
  ...
  public: {
    ...
    Views: {
      cycle_employee_summary_employee_view: {
        Row: {
        ...
        Insert: {
          ...
          cycle_id?: string | null
          employee_id?: string | null
          final_narrative_employee_visible?: never
          final_score?: number | null
          finalized_at?: string | null
          id?: string | null
          performance_rating?: never
          performance_rating_value?: number | null
          released_at?: string | null
          released_by?: string | null
          summary_employee_visible?: string | null
      ...
      reviews_employee_view: {
        ...
        Insert: {
          ...
          status?: Database["public"]["Enums"]["review_status"] | null
          submitted_at?: string | null
          summary_employee_visible?: never
          updated_at?: string | null
        }
        Update: {
          assignment_id?: string | null
    ...
    Functions: {
      ...
      admin_preview_employee_cycle_summary: {
        Args: {
      ...
      is_reviewer_for_employee: { Args: { emp_id: string }; Returns: boolean }
